...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--in_dir", type=str, default="dataset/vctk-22k", help="path to input dir"
    )
    parser.add_argument(
        "--wav_dir", type=str, default="dataset/sr/wav", help="path to output wav dir"
    )
    parser.add_argument(
        "--ssl_dir", type=str, default="dataset/sr/wavlm", help="path to output ssl dir"
    )
